...
- `void setVersion(String version)`
    ...
    - Possible argument notations:
        - A forge/fml buildnumber, eg: `1563`
        - A forge/fml promotion,, eg: `1.11.2-latest`, `1.11.2-recommended`
        - A forge/fml version string potentially including a branch appendage, eg : `13.20.0.2228`, `13.20.0.2228-1.11.2`
        - A full minecraft + forge/fml version string potentially including a branch appendage in form `mcVersion-forge/fmlversion(-branch)`: `1.11.2-13.20.0.2228`, `1.8-11.14.4.1563-1.8`
- `String getVersion()`
    - Returns the only the minecraft version. eg: `1.8`, `1.11.2`. For the Forge/fml version, use getApiVersion()
