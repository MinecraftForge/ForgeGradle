...
abstract class MinecraftDependencyImpl implements MinecraftDependencyInternal {
    ...
    @UnknownNullability Provider<ExternalModuleDependency> delegate;
    ...
    static abstract class WithAccessTransformersImpl extends MinecraftDependencyImpl implements MinecraftDependencyInternal.WithAccessTransformers {
        ...
        Provider<ExternalModuleDependency> setDelegate(Object dependencyNotation, Closure<?> closure) {
            return this.delegate = (Provider<ExternalModuleDependency>) this.atContainer.dep(super.setDelegate(dependencyNotation, closure));
        }
        ...
        @Override
        public void setAccessTransformer(Provider<?> configFile) {
            this.accessTransformer(it -> it.setConfig(configFile));
        }

        @Override
        public void setAccessTransformer(RegularFile configFile) {
            this.accessTransformer(it -> it.setConfig(configFile));
        }

        @Override
        public void setAccessTransformer(File configFile) {
            this.accessTransformer(it -> it.setConfig(configFile));
        }

        @Override
        public void setAccessTransformer(Object configFile) {
            this.accessTransformer(it -> it.setConfig(configFile));
        }
