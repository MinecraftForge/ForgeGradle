...
import static net.minecraftforge.gradle.old.dev.DevConstants.CROWDIN_FORGEID;
import static net.minecraftforge.gradle.old.dev.DevConstants.CROWDIN_ZIP;
import static net.minecraftforge.gradle.old.dev.DevConstants.EXC_MODIFIERS_DIRTY;
...
public class FmlDevPlugin extends DevBasePlugin
{
    ...
    protected void createJarProcessTasks()
    {
        ...
        DeobfuscateJar task2 = makeTask("deobfuscateJar", DeobfuscateJar.class);
        {
            ...
            task2.setOutJar(delayedFile(DevConstants.JAR_SRG_FML));
    ...
    private void createPackageTasks()
    {
        ...
        final DelayedJar uni = makeTask("packageUniversal", DelayedJar.class);
        {
            ...
            uni.from(delayedTree(DevConstants.FML_RESOURCES));
